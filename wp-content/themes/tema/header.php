...
<head>
    ...
    <meta name="description"
        content="Vi leverer det ultimative mobildiskotek og professionelle DJ-services. Få fuld pakke med musik, lyd og lys til alle typer af fester.">
        ...
        <div class="container">
            <nav aria-label="Main menu">
                ...
                <div class="navRight">
                    ...
                    <div class="extendBtn">
                        <button>
                            <img src="<?php echo esc_url($HeaderPhoneMenu["url"]); ?>"
                                alt="hamburbur knap / telefon navigation menu">
                        </button>
                    </div>
                </div>
            </nav>
        ...
        <div class="main-container">
            <div class="main-content-wrapper">
                ...
                <div class="button-wrapper">
                    <div class="btnwrap">
                        <a class="heroBtn1" href="<?php echo esc_url( $link_url ); ?>"
                            target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
                    </div>

                    <a class="heroBtn2" href="<?php echo esc_url( $link2_url ); ?>"
                        target="<?php echo esc_attr( $link2_target ); ?>"><?php echo esc_html( $link2_title ); ?></a>
                </div>
            </div>
        </div>
    </header>
