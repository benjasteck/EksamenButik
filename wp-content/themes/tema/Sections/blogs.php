                ...
                <div class="blogText">
                    <div class="blogTextContent">
                        ...
                        <div class="tagContainer">
                            ...
                            <?php endif; ?>
                            <?php if ($tag1): ?><a href="<?php echo esc_url($tag1["url"]); ?>" class="tag"><?php echo esc_html($tag1["title"]); ?></a><?php endif; ?>
                            <?php if ($tag2): ?><a href="<?php echo esc_url($tag2["url"]); ?>" class="tag"><?php echo esc_html($tag2["title"]); ?></a><?php endif; ?>
                            <?php if ($tag3): ?><a href="<?php echo esc_url($tag3["url"]); ?>" class="tag"><?php echo esc_html($tag3["title"]); ?></a><?php endif; ?>
                        </div>
