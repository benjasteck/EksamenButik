        ...
        <div class="bookingText">
            <div class="bookingText1">
                ...
                <div class="bookingTextRight">
                    <div>Benyt kontaktformularen og beskriv jeres arrangement. I sidder sikkert inde med en masse tanker og sjove indslag i ønsker klarlagt. Skriv disse tanker til os, samt information om lokation i landet, antal af gæster til festen og de andre små ting som er så vigtigt for detaljerne og den gode fest.</div>
                </div>
            </div>
            <div class="bookingText2">
                ...
                <div class="bookingTextRight">
                    <div>Efter vi har modtaget din henvendelse over mail eller telefon får du tilsendt et skriftligt tilbud til gennemlæsning. Heri er beskrevet alt du skal vide når du booker hos MusikDJ. Bekræft tilbuddet, forbered nogle gode sangønsker som I ved vil være et hit og lad os klare resten af forberedelserne.</div>
                </div>
            </div>
