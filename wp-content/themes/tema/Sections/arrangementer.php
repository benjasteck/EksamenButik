...
<section id="arrangementer">
    ...
    <div class="image-group">
        ...
        <div class="stickyImg">
            <img src='<?php echo esc_url($firmafest["url"]); ?>' loading="lazy" alt="<?php echo $firmafest ["alt"]?>">
        ...
        <div class="stickyImg">
            <img src='<?php echo esc_url($konfirmationfest["url"]); ?>' loading="lazy" alt="<?php echo $konfirmationsfest ["alt"]?>">
    ...
    <div class="image-group" id="image-group2">
        <div class="stickyImg">
           <img src='<?php echo esc_url($gymnasiefest["url"]); ?>' loading="lazy" alt="<?php echo $gymnasiefest ["alt"]?>"> 
        ...
        <div class="stickyImg">
           <img src='<?php echo esc_url($efterskolefest["url"]); ?>' loading="lazy" alt="<?php echo $efterskolefest ["alt"]?>"> 
        ...
        <div class="stickyImg">
           <img src='<?php echo esc_url($ungdomfest["url"]); ?>' loading="lazy" alt="<?php echo $ungdomfest ["alt"]?>"> 
    ...
    <div class="image-group" id="image-group3">
        <div class="stickyImg">
            <img src='<?php echo esc_url($bornefest["url"]); ?>' loading="lazy" alt="<?php echo $bornefest ["alt"]?>">
        ...
        <div class="stickyImg">
            <img src='<?php echo esc_url($fodselsdagfest["url"]); ?>' loading="lazy" alt="<?php echo $fodselsdagfest ["alt"]?>">
